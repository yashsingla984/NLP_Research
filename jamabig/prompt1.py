...
dataframe1 = pd.read_excel('output_check.xlsx')
    ...
    for attempt in range(max_retries):
        try:
            ...
            if answer_match:
                ...
                #dataframe2.at(i,'Answer_chatgpt']=answer
                #dataframe2.at[ind,'Explanation']=explanation
                print(ind)
...
dataframe2.to_excel("output_chatgpt_check.xlsx")
# print(dataframe2.iloc[0])
print("yassssh")
#print(messages)
