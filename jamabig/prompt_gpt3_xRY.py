...
for ind in dataframe1.index:
    ...
    message="Title: "+title+" Case is: "+caseart+question+" "+"A: "+option1+" ,"+" "+"B: "+option2+" ,"+" "+"C: "+option3+" ,"+" "+"D: "+option4+". "+"Please choose an answer option. The output format is:  (fill in the letter of the answer). Alphabetical letter only and also provide the Explanation:"
    #print(message)
    if len(message)>=4050:
    ...
    for attempt in range(max_retries):
        try:
            ...
            if answer_match:
                ...
                dataframe2.at[ind,'Explanation']=reply
...
dataframe2.to_excel("output_gpt4_X_YR_temp.xlsx")
# print(dataframe2.iloc[0])
print("yassssh")
#print(messages)
